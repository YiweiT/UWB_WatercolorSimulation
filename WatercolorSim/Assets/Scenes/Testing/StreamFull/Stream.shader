Shader "StreamFull/Stream"
{
    ...
    fixed4 stream_diagonal (v2f i) : SV_Target
    {
        ...
        float inComing1 = neighbor_lookUp1(_tex1, i.uv - float2(e5.x * _tex1_TexelSize.x, e5.y * _tex1_TexelSize.y)).r;
        float inComing2 = neighbor_lookUp1(_tex1, i.uv - float2(e6.x * _tex1_TexelSize.x, e6.y * _tex1_TexelSize.y)).g;
        float inComing3 = neighbor_lookUp1(_tex1, i.uv - float2(e7.x * _tex1_TexelSize.x, e7.y * _tex1_TexelSize.y)).b;
        float inComing4 = neighbor_lookUp1(_tex1, i.uv - float2(e8.x * _tex1_TexelSize.x, e8.y * _tex1_TexelSize.y)).a;
        
        // float2 e2 = float2(0, 1);
        col.r = streaming(_tex1, _tex1_TexelSize, f1, f3, e5, ki, i.uv, inComing1); // E
        col.g = streaming(_tex1, _tex1_TexelSize, f2, f4, e6, ki, i.uv, inComing2); // N
        col.b = streaming(_tex1, _tex1_TexelSize, f3, f1, e7, ki, i.uv, inComing3); // W
        col.a = streaming(_tex1, _tex1_TexelSize, f4, f2, e8, ki, i.uv, inComing4); // S
