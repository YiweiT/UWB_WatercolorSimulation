...
public class BoundaryTest : MonoBehaviour
{
    ...
    public Shader paintShader, fillShader, boundaryShader;
    // user input
    ...
    Material paintMat, fillMat, myMat, boundaryMat;
    ...
    void Start()
    {
        ...
        boundaryMat.SetTexture("_RefTex3", debugRT1);
        boundaryMat.SetTexture("_RefTex4", debugRT2);
